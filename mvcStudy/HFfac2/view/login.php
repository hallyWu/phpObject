...
<body>
    ...
    <div id="f_login">
        ...
        <form method="post"  name="login">
            ...
            <p>
                <span>验 证 码：</span>
                <input id="code" type="text" value="" maxlength="4" name="code" >
            ...
            <p><input id='loginBtn' type="button" value="登录" id="nnn"></p>
        </form>
    </div>
</body>
...
<script>
    ...
    $(function(){
        $('#loginBtn').click(function(){
            ...
            $.ajax({
                url:"./index.php?c=Login&a=loginAjax",
                type:"post",
                data:form,
                success:function(res){
                    ...
                    if(res==1){
                        alert('登入成功');
                        window.location.href = "./index.php?c=Login&a=main"
                    }else if(res==0){
                        alert('登入失败');
                    }else if(res==-1){
                        alert('验证码错误');
