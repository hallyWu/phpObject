...
CREATE TABLE goods_status(
  goods_status_id int(11) unsigned NOT NULL PRIMARY KEY DEFAULT '101' COMMENT '状态id',
  goods_status VARCHAR(30) NOT NULL COMMENT "状态值"
);
...
-- 商品列表
  CREATE TABLE sp_goods(
    ...
    goods_status int(11) unsigned NOT NULL DEFAULT '101' COMMENT '商品状态',
